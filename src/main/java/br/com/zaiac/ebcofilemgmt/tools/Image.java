...
public class Image {
    ...
    public static void getImageCheioVazio(String baseDir, String urlIaLocal, String trkId) throws IOException {
        try {
        ...
        try {
            LogApp.writeLineToFile(logDirectory, Constants.LOGFILE, "Cheio/Vazio analyse started to " + trkId + "...", 0);
        } catch(IOException e) {
        ...
        try {
            ...
            writer.close();        
            LogApp.writeLineToFile(logDirectory, Constants.LOGFILE, "Cheio/Vazio Response for " + trkId + " " + apiOutput, 0);
        } catch (Exception e) {
